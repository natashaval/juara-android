package com.example.happybirthday.waterme.adapter
...
import com.example.happybirthday.databinding.ListWaterItemBinding
import com.example.happybirthday.waterme.model.Plant
...
class PlantAdapter(private val longClickListener: PlantListener) :
    ...
    class PlantViewHolder(
        private val binding: ListWaterItemBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlantViewHolder {
        ...
        return PlantViewHolder(
            ListWaterItemBinding.inflate(layoutInflater, parent, false)
        )
    }
