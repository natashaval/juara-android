...
import com.example.happybirthday.dogglers.BaseTest.DrawableMatcher.withDrawable
...
open class BaseTest {
  ...
  private fun hasListItemContent(name: String, age: String, hobbies: String, imageResource: Int) {
    ...
    Espresso.onView(ViewMatchers.withText(age))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(ViewMatchers.withText(hobbies))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(withDrawable(imageResource))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
  }
